...
public class LambdaExpresionDemo{
    public static void main(String args []){
        ...
        new Thread(new codeToRun()).start();         //Creating a thread of class codeToRun So that run method will execute as an independdent thread
        
        //Creating another Thread using anonymous class 
        new Thread(new Runnable (){
            public void run (){
                System.out.println("Hello From Thread 2 in Ehich Runnable Interface is implemented Using Anonymous Class");
        ...
        new Thread (()-> System.out.println("Hello From Thread 3 in Ehich Runnable Interface is implemented Using Lambda Expression...")).start();
