...
public class StringBufferClassDemo{
    public static void main(String [] args ){
        ...
        strbuf.append("Osama Bin Azam");             //Append my name with strbuf. Append (Used to add text at the end of the string)
        System.out.println(strbuf);

        System.out.println("\nThe Length of the Strbuf After append() is : " + strbuf.length());  // Printing the length of String
